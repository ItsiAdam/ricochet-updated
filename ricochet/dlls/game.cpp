...
cvar_t rc_enable_jump = {"rc_enable_jump", "0", FCVAR_SERVER | FCVAR_UNLOGGED};
cvar_t rc_enable_crouch = {"rc_enable_crouch", "0", FCVAR_SERVER | FCVAR_UNLOGGED};
...
void GameDLLInit(void)
{
	...
	CVAR_REGISTER(&rc_enable_jump);
	CVAR_REGISTER(&rc_enable_crouch);
