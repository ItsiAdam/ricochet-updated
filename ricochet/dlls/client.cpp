...
void ClientUserInfoChanged(edict_t *pEntity, char *infobuffer)
{
	...
	const char *currentModel = g_engfuncs.pfnInfoKeyValue(infobuffer, "model");
	bool isFemale = strcmp("models/player/female/female.mdl", currentModel) == 0;
	bool isMale = strcmp("models/player/male/male.mdl", currentModel) == 0;

	if (!isMale && !isFemale)
	{
		SET_MODEL(pEntity, "models/player/female/female.mdl");
		g_engfuncs.pfnSetClientKeyValue(ENTINDEX(pEntity), infobuffer, "model", "female");
	}
